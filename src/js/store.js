...
(function () {
  ...
  CT.defaultState = () => ({
    ...
    prefs: { likes: {}, allergens: [], diet: 'omni', maxActive: 15, meals: { B: true, L: true, D: true, S: true }, equipment: { stove: true, oven: true, microwave: true, blender: true }, budget: 'normal', lazy: false, cuisine: 'italian', chickenPerWeek: 0, autoPortion: false, slotTime: { B: 15, L: 15, D: 'nocook', S: 10 },
      slotCfg: {
        B: { name: 'Colazione', time: '08:00', share: 0.24 },
        S: { name: 'Spuntino', time: '16:00', share: 0.15 },
        L: { name: 'Cena', time: '19:00', share: 0.40 },
        D: { name: 'Seconda cena', time: '02:00', share: 0.45 },
      } },
